...
public class TestHamcrest {
    ...
    assertThat("Number of Search Box/esis not 1", driver.findElements(By.id("search")).size(), is(1));
    ...
    assertThat("Element name is: ", listElement, is(equalTo(expectedString)));
   ...
   // assertThat("Cart button is not displayed: ", cartElement, is(true));
    ...
    assertThat(agreeElement, is(false));
